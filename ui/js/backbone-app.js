...
App.ModuleDetailView = Backbone.View.extend({
    ...
    initialize: function(options) {
        ...
        self.listenTo(this.collection, "add", function(e){console.log(e)});

        //console.log('ModuleDetailView initialized');
        var relatedSolutions = this.model.get('related_solutions');
        _.each(relatedSolutions, function(name){
           //console.log(name);
           var solution = App.Modules.findWhere({title: name });
           self.collection.add(solution);
        });
    },
